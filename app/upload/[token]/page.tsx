  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/public/upload-invoice/${params.token}`,
        {
          method: "POST",
          body: data,
        },
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg mb-6">
                ...
                {invoiceData && (
                  <div className="text-sm mt-2">
                    <p>
                      <strong>Número:</strong> {invoiceData.invoiceNumber}
                    </p>
                    <p>
                      <strong>Proveedor:</strong> {invoiceData.supplier}
                    </p>
                    <p>
                      <strong>Monto:</strong> {invoiceData.amount} EUR
                    </p>
                  </div>
                )}
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Input
                ...
                type="text"
                placeholder="Perusahaan Proveedora S.L."
                required
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <p className="text-sm text-gray-600 text-center">
                Esta URL es privada y segura. Solo personas con el enlace pueden
                acceder.
              </p>
            </div>
          </div>
