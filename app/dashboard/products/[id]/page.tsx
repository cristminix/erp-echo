...
export default function EditProductPage() {
  ...
  const fetchProduct = async () => {
    try {
      ...
      if (!companiesRes.ok) {
        setError("Gagal mendapatkan perusahaan aktif")
        setLoading(false)
        return
      }
      ...
      if (!activeCompany) {
        setError("Tidak ada perusahaan aktif")
        setLoading(false)
        return
      }

      const res = await fetch(
        `/api/products/${productId}?companyId=${activeCompany.id}`,
      )
      if (res.ok) {
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex items-center text-blue-800">
                  ...
                  <span className="font-medium">
                    Ini adalah layanan - tidak ada pengelolaan stok
                  </span>
                </div>
              </div>
            )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent bg-white text-gray-900"
                >
                  <option value="unidad">Satuan</option>
                  <option value="kg">Kilogram</option>
                  <option value="litro">Liter</option>
                  <option value="metro">Metro</option>
                  <option value="caja">Kotak</option>
                  <option value="paquete">Paket</option>
                </select>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent bg-white text-gray-900"
                >
                  <option value="storable">Dapat Disimpan (dengan stok)</option>
                  <option value="service">Layanan (tanpa stok)</option>
                </select>
              </div>
            </div>
          </div>
