...
export default function EditCompanyPage() {
  ...
  const handleTestEmail = async () => {
    if (!formData.smtpHost || !formData.smtpUser || !formData.smtpPassword) {
      alert(
        "Por favor completa primero la configuración SMTP antes de hacer la prueba.",
      )
      return
    }
  ...
  const handleGenerateApiKey = async () => {
    if (
      apiKey &&
      !confirm(
        "¿Estás seguro de generar una nueva API Key? La anterior dejará de funcionar.",
      )
    ) {
      return
    }
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert(
          "✅ API Key generada exitosamente. Cópiala y guárdala en un lugar seguro.",
        )
      } else {
        alert(`❌ Error: ${data.error}`)
      }
  ...
  const disableUploadToken = async () => {
    if (
      !confirm(
        "¿Estás seguro de que deseas deshabilitar el token de subida? El enlace público dejará de funcionar.",
      )
    ) {
      return
    }
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pt-4 border-t border-gray-200">
              ...
              <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ol className="space-y-3 text-sm text-blue-900">
                  <li className="flex items-start">
                    <span className="font-bold mr-2 bg-blue-200 w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0">
                      1
                    </span>
                    <div>
                      <strong>Habilita la verificación en 2 pasos</strong>
                      <p className="text-blue-800 mt-1">
                        Ve a tu cuenta de Google → Seguridad → Verificación en 2
                        pasos y actívala
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-blue-800 mt-1">
                        Selecciona "Correo" y "Otro dispositivo", ponle un
                        nombre (ej: "ERP") y genera
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-blue-800 mt-1">
                        ...
                        Cópiala y pégala en el campo "Contraseña SMTP" abajo
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      <strong>Completa el campo Pengguna SMTP</strong>
                      <p className="text-blue-800 mt-1">
                        Ingresa tu correo completo de Gmail (ejemplo@gmail.com).
                        El nombre del remitente será automáticamente el nombre
                        de tu empresa.
                      </p>
                    </div>
                  </li>
                ...
                <div className="mt-4 p-3 bg-blue-100 rounded border border-blue-300">
                  <p className="text-sm text-blue-900">
                    <strong>⚠️ Importante:</strong> Los campos Host
                    (smtp.gmail.com) y Puerto (587) ya están configurados
                    automáticamente.
                  </p>
                </div>
              </div>
            ...
            <div className="mt-3 text-sm text-gray-600 bg-gray-50 p-3 rounded-lg border border-gray-200">
              <strong>ℹ️ Nota:</strong> El nombre del remitente será
              automáticamente el nombre de tu empresa y el email será el
              Pengguna SMTP configurado arriba.
            </div>
            ...
            <div className="mt-6">
              ...
              <p className="mt-2 text-sm text-gray-500">
                Si está vacío, se usará una plantilla profesional
                predeterminada. Puedes personalizar con HTML y usar variables
                como:{" "}
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="mt-2 text-sm text-red-600">
                        ⚠️ Guarda esta clave de forma segura. No la compartas
                        públicamente.
                      </p>
                    </div>
  ...
  -H 'X-API-Key: ${apiKey}'`}
                      ...
                      <details className="mt-2">
                        ...
                        <ul className="mt-2 text-xs text-gray-600 space-y-1 list-disc list-inside">
                          <li>
                            <code>status</code>: DRAFT, PENDING, PAID, CANCELLED
                          </li>
                          <li>
                            <code>paymentStatus</code>: PENDING, PARTIAL, PAID,
                            OVERDUE
                          </li>
                          <li>
                            <code>startDate</code>: Fecha inicio (YYYY-MM-DD)
                          </li>
                          <li>
                            <code>endDate</code>: Fecha fin (YYYY-MM-DD)
                          </li>
                          <li>
                            <code>limit</code>: Máximo de resultados (1-100,
                            default: 100)
                          </li>
                          <li>
                            <code>offset</code>: Offset para paginación
                            (default: 0)
                          </li>
                        </ul>
                      </details>
          ...
          <div className="pt-4 border-t border-gray-200">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">
              URL de Subida Pública de Facturas
            </h3>
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
                Genera una URL pública para que proveedores o empleados puedan
                subir facturas de compra directamente sin necesidad de iniciar
                sesión.
              </p>
                ...
                <label className="inline-flex items-center cursor-pointer">
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        uploadTokenEnabled: e.target.checked,
                      })
                    }
                    className="sr-only peer"
                  />
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="mt-2 text-sm text-amber-600">
                      ⚠️ No compartas este enlace públicamente. Solo envíalo a
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <p className="text-sm font-semibold text-blue-800 mb-2">
                      ¿Qué permite este enlace?
                    </p>
                    <ul className="text-sm text-blue-700 space-y-1 list-disc list-inside">
                      <li>
                        Subir facturas de compra con adjuntos (PDF, JPG, PNG)
                      </li>
                      <li>
                        Crear automáticamente contactos de proveedores si no
                        existen
                      </li>
