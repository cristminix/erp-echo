...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log(
      "[Dashboard Stats] Buscando empresa activa para userId:",
      userId,
    )
    ...
    console.log(
      "[Dashboard Stats] Perusahaan activa encontrada:",
      activeCompany?.id,
    )
    ...
    if (!activeCompany) {
      console.log(
        "[Dashboard Stats] No hay empresa activa, buscando primera empresa",
      )
      ...
      console.log(
        "[Dashboard Stats] Primera empresa encontrada:",
        activeCompany?.id,
      )
    }
    ...
    const primaryCurrency =
      Object.keys(salesRevenueByCurrency).sort(
